...
public class ItemsCancelArgs : EventArgs
{
	...
	private List<Object> <Items>k__BackingField; //Field offset: 0x10
	...
	[Address(RVA = "0x5C75E0", Offset = "0x5C67E0", Length = "0x65")]
	[CalledBy(Type = typeof(ItemsControl), Member = "RemoveSelectedItems", ReturnType = typeof(void))]
	...
	[DeduplicatedMethod]
	[Token(Token = "0x60000EA")]
	public void set_Items(List<Object> value) { }
