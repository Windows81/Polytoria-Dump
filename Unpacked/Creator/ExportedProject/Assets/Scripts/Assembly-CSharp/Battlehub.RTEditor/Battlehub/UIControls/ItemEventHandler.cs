...
public sealed class ItemEventHandler : MulticastDelegate
{
	...
	public ItemEventHandler(object object, IntPtr method) { }
	...
	public override IAsyncResult BeginInvoke(ItemContainer sender, PointerEventData eventData, AsyncCallback callback, object object) { }
	...
	public override void Invoke(ItemContainer sender, PointerEventData eventData) { }
