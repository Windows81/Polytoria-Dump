...
internal static class WhitespaceReader
{
	...
	[Address(RVA = "0x1731A90", Offset = "0x1730C90", Length = "0x396")]
	...
	[CalledBy(Type = typeof(MailAddressParser), Member = "ReadCfwsAndThrowIfIncomplete", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(string), typeof(int)}, ReturnType = typeof(int))]
	...
	[Address(RVA = "0x1731E30", Offset = "0x1731030", Length = "0x459")]
